...
Most of the **@eresearchqut/flex-layout** functionality is provided via Directives used **declaratively** in template HTML. 
...
```typescript
import {BREAKPOINTS} from '@eresearchqut/flex-layout';
...
As each directive (aka API) within **@eresearchqut/flex-layout** has its own constraints and options, 

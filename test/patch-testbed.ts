 ...
 * each unit test.
 *
 * Without this patch, the combination of two behaviors is problematic for Angular Layout:
 ...
 */
export function patchTestBedToDestroyFixturesAfterEveryTest(testBedInstance: TestBed) {

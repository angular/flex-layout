...
// Package definition for lib api docs. This only *defines* the package- it does not yet
...
let apiDocsPackage = new DgeniPackage('flex-layout-api-docs', dgeniPackageDeps)

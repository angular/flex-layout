...
Installing flex-layout with **NPM** is *not yet* available. Developers can, however, easily install this `@angular/flex-layout` library using a **local repository build** and a directory copy:

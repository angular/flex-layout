...
This project represents the **re-architecture** and isolation of Angular Material's Layout flexbox features into a *pure Angular-only*, stand-alone Layout engine. This is **flexbox2016** with **Angular**-superpowers!
